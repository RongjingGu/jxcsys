    ...
    return (
      <div>
        ...
        <div style={{ position: 'relative' }}>
          <SearchBar style={{ marginRight: '60px' }} placeholder="关键词搜索" maxLength={50} onSubmit={e => search(e, this.props.dispatch)} />
          <span style={{ float: 'right', position: 'absolute', right: '20px', top: '12px' }}>全部</span>
        </div>
...
export default connect()(InvSubject);
